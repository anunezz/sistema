...
<script>
    export default {
        ...
        methods : {
            ...
            count(){
             let me = this;
                    axios.get('/categoria/count').then(function (response) {
                        console.log("RESPONSE COUNT CATEGORIAS: ",response.data.categorias);
                        console.log("RESPONSE COUNT ARTICULOS: ",response.data.articulos);
